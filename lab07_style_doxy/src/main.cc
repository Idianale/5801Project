...
#include "/home/hans4837/csci3081/repo-hans4837/labs/lab07_style_doxy/src/passenger.h"
...
int main() {
  ...
  while (time < 60) {
    ...
    for (int i = passengers.begin(); i != passengers.end(); it++) {
      if ((*it)->GetDestination() != time) {
        ...
        next element. We need to push it back so that the for loop increment
